...
> **Network:** Entropy Network (ɸ-net) · Permission‑less · Immutable · Proof‑of‑Infinity
...
| ---- | ------------------ | ----------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | **Connect Wallet** | —                             | MetaMask / WalletConnect. UI detects ɸ-net testnet chain ID; warns if user is on the wrong chain.                                                     |
