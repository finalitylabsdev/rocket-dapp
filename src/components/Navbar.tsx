        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[10px] font-medium leading-none mt-0.5 font-mono tracking-wider" style={{ color: '#4A5468' }}>E-NET | φ-NET · PROOF-OF-INFINITY</div>
            </div>
          </div>

          <div className="hidden md:flex items-center gap-1">
            {wallet.isConnected && (
              <div className="flex items-center gap-1.5 text-zinc-400 font-mono font-medium text-sm px-3 py-2 bg-zinc-900/50 border border-border-subtle mr-1">
            ...
            <a
              href="#"
              className="flex items-center gap-1.5 text-zinc-400 hover:text-white font-mono font-medium text-sm px-4 py-2 hover:bg-zinc-900 transition-all duration-200"
            >
              <FileText size={15} />
              DOCS
            </a>
          ...
          <button
            ...
            className="md:hidden w-10 h-10 flex items-center justify-center hover:bg-zinc-900 transition-colors"
          >
          ...
          <div className="md:hidden pb-4 space-y-1 border-t border-border-subtle pt-4">
            {wallet.isConnected && (
              <div className="flex items-center gap-2 px-4 py-2">
                <PhiSymbol size={13} color="#E8ECF4" />
                <span className="font-bold text-white text-sm font-mono">{game.fluxBalance}</span>
                <span className="text-xs text-zinc-500 font-mono">FLUX</span>
              </div>
            )}
            <a href="#" className="flex items-center gap-2 text-zinc-400 font-mono font-medium text-sm px-4 py-3 hover:bg-zinc-900">
              <FileText size={15} />
              DOCS
            </a>
            <button
              onClick={() => { onNavigate?.('leaderboard'); setMobileOpen(false); }}
              className="w-full flex items-center gap-2 text-zinc-400 font-mono font-medium text-sm px-4 py-3 hover:bg-zinc-900"
            >
              <Trophy size={15} />
              JACKPOT
            </button>
            <div className="pt-2 px-2">
              {wallet.isConnected ? (
                <div className="flex items-center gap-2">
                  <div className="flex-1 flex items-center gap-2 bg-zinc-900 border border-border-subtle px-3 py-2.5">
                    <div className="glow-dot" />
                    <span className="text-xs font-mono font-semibold text-zinc-300">{wallet.displayAddress}</span>
                  </div>
                  <button
