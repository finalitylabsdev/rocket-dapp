...
export const AUCTION_ROUND_SECONDS = 3_600;
export const AUCTION_SUBMISSION_WINDOW_SECONDS = 900;
export const AUCTION_BIDDING_WINDOW_SECONDS = AUCTION_ROUND_SECONDS - AUCTION_SUBMISSION_WINDOW_SECONDS;
