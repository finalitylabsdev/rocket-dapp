/*
  # Add server-backed Star Vault inventory and mystery box RPCs

  ## Summary
  - Adds the server-authoritative inventory_parts table
  - Allows users to read their own inventory directly
  - Adds open_mystery_box() for atomic Flux spend + part generation
  - Adds get_user_inventory() for enriched inventory reads
*/
...
DROP POLICY IF EXISTS "Users read own inventory" ON inventory_parts;
